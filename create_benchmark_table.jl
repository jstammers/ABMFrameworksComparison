...
frameworks = ["Agents.jl", "Ark.jl", "Mason", "NetLogo", "Mesa", "KrABMaga"]
...
columns = ["Model/Framework", "Agents.jl 6.2.10", "Ark.jl 0.3.2", "MASON 22.0", "Netlogo 6.4.0", "Mesa 3.2.0", "KrABMaga 0.6.1"]
